...
void Initialize() {
    ...
    Image* image = loadBMP("C:\\Users\\Administrator\\Desktop\\graphics\\stone.bmp");
    _textureBrick = loadTexture(image);
    image = loadBMP("C:\\Users\\Administrator\\Desktop\\graphics\\door.bmp");
    _textureDoor = loadTexture(image);
    image = loadBMP("C:\\Users\\Administrator\\Desktop\\graphics\\grass.bmp");
    _textureGrass = loadTexture(image);
    image = loadBMP("C:\\Users\\Administrator\\Desktop\\graphics\\roof.bmp");
    _textureRoof = loadTexture(image);
    image = loadBMP("C:\\Users\\Administrator\\Desktop\\graphics\\window.bmp");
    _textureWindow = loadTexture(image);
    image = loadBMP("C:\\Users\\Administrator\\Desktop\\graphics\\sky.bmp");
